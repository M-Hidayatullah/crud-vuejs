...
@section('content')
	...
	<div id="UserController" style="padding-top: 2em">
		...
		<form action="#" @submit.prevent="AddNewUser" method="POST">
			...
			<div class="form-group">
				<button :disabled="!isValid" class="btn btn-default" type="submit" v-if="!edit">Tambah User</button>
		...
		<div class="alert alert-success" transition="success" v-if="success">Tambah user Berhasil.</div>
